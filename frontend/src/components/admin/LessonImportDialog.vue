  ...
  <q-dialog v-model="isOpen" persistent maximized transition-show="slide-up" transition-hide="slide-down">
    <q-card>
      <q-bar class="bg-primary text-white">
        <div class="text-subtitle1">Import Pembelajaran</div>
        <q-space />
        ...
        <q-stepper v-model="step" color="primary" animated flat>
          <q-step :name="1" title="Upload File" icon="upload_file" :done="step > 1">
            <q-banner dense rounded class="bg-blue-1 text-blue-9 q-mb-md">
              ...
              Format CSV: <code>mapel_kode,kelas_nama,guru_username,tahun_ajaran,semester</code>
              <br />
              <code>mapel_kode</code>, <code>kelas_nama</code>, <code>guru_username</code> harus sesuai data yang sudah
              ada.
            </q-banner>
          ...
          <q-step :name="2" title="Preview & Validasi" icon="visibility">
            ...
            <div class="row q-gutter-sm q-mt-md">
              ...
              <q-btn color="positive" :label="`Import ${importValidCount} Pembelajaran`"
                :disable="importValidCount === 0" :loading="importing" @click="onConfirmImport" />
              <q-btn flat color="grey" label="Batal" @click="onClose" />
            </div>
          </q-step>
        </q-stepper>
...
const previewColumns = [
  ...
  { name: 'mapel_kode', label: 'Kode Mapel', field: 'mapel_kode', align: 'left' },
  { name: 'kelas_nama', label: 'Kelas', field: 'kelas_nama', align: 'left' },
  { name: 'guru_username', label: 'Guru', field: 'guru_username', align: 'left' },
  { name: 'academic_year', label: 'T.A.', field: 'academic_year', align: 'center' },
  { name: 'semester', label: 'Smt', field: 'semester', align: 'center' },
