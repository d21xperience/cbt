          ...
          <q-card-section>
            ...
            <q-form @submit.prevent="showConfirmDialog" class="q-gutter-md">
              ...
              <q-banner v-if="archiveForm.is_end_of_academic_year" class="bg-negative text-white q-mb-md" rounded>
                ...
                <b>MODE AKHIR TAHUN AJARAN:</b> Semua data akan di-reset termasuk konfigurasi ujian, soal, dan sesi.
              </q-banner>
              ...
              <template v-slot:body-cell-stats="props">
                <q-td :props="props">
                  <div class="text-caption">
                    <div><b>{{ props.row.archived_participants }}</b> peserta</div>
                    <div><b>{{ props.row.archived_exams }}</b> ujian</div>
                    <div><b>{{ props.row.archived_sessions }}</b> sesi</div>
                  </div>
                </q-td>
              </template>
            </q-table>
      ...
      <q-card style="min-width: 500px;">
        ...
        <q-card-section>
          <div class="text-body1 q-mb-md">
            Anda akan melakukan archive dengan detail:
          </div>
            ...
            <q-item>
              <q-item-section>
                ...
                <q-item-label caption>
                  <q-badge :color="archiveForm.is_end_of_academic_year ? 'negative' : 'primary'"
                    :label="archiveForm.is_end_of_academic_year ? 'Akhir Tahun Ajaran' : 'Semester Biasa'" />
                </q-item-label>
              </q-item-section>
            </q-item>
          </q-list>
...
const archiveColumns = [
  ...
  { name: 'is_end_of_academic_year', label: 'Mode', field: 'is_end_of_academic_year', align: 'center' },
